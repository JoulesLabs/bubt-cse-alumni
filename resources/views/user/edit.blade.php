                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush rounded-3 p-3 mb-2">
                                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                            ...
                                            <p class="mb-0">
                                                <input type="url" value="{{$user?->information?->facebook}}" name="facebook" placeholder="Enter facebook account link" >
                                            </p>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                            <i class="fab fa-linkedin-in fa-lg" style="color: #55acee;"></i>
                                            <p class="mb-0">
                                                <input type="url" value="{{$user?->information?->linkedin}}" name="linkedin" placeholder="Enter linkedin account link" >
                                            </p>
                                        </li>
                                        <li class="list-group-item d-flex justify-content-between align-items-center p-3">
                                            <i class="fab fa-github fa-lg" style="color: #ac2bac;"></i>
                                            <p class="mb-0">
                                                <input type="url" value="{{$user?->information?->github}}" name="github" placeholder="Enter github account link" >
                                            </p>
                                        </li>
                                    </ul>
                                </div>
